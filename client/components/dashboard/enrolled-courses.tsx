...
export function EnrolledCourses({ courses }: EnrolledCoursesProps) {
  return (
    <Card className="border-none bg-white shadow-sm transition-all duration-300 dark:bg-slate-900">
      <CardHeader className="pb-2">
        <CardTitle className="text-xl font-medium text-primary">My Courses</CardTitle>
      </CardHeader>
      <CardContent>
        {courses.length > 0 ? (
